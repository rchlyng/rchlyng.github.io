# CSE 11 Spring 2023 PA1 - Grade Calculator
**Due date: Thursday, April 13 @ 11:59PM PDT**

There is an [FAQ post](https://piazza.com/class/lfx8rc63u25xd/post/18) on Piazza. Please read that post first if you have any questions.
...
We take Academic Integrity (AI) very seriously at UCSD. Before beginning the assignment please fill out the [AI form](https://docs.google.com/forms/d/e/1FAIpQLSeVXY02K6UxfRAq58GEfNUx8Z8C3HS27gix3Tihy1Sv-ZSnRg/viewform). **You must fill this out in order to recieve points for any assignments.**

## Part 2: Technology Access Survey [1 point]
Please fill out this [Technology Access Survey](https://canvas.ucsd.edu/courses/45010/quizzes/135864) on Canvas to help us understand the background and goals of the students in this course and meet the new financial aid requirement.
...
## Submission
Submit all of the following files to Gradescope by **Thursday, April 13 @ 11:59PM PDT**.
...
* **Coding Style** [0 points]
  * You will receive feedback on your coding style after grades are released. For this assignment only, style is worth 0 points. You are highly encouraged to practice good styling on this PA.
